...
export default function MessageList({ messages, isLoading, currentUserId, onDeleteMessage, showTypingIndicator }: MessageListProps) {
              ...
              <div ref={openMenuMessageId === message.id ? menuRef : null} className="group relative max-w-xs lg:max-w-md">
                ...
                >
                  {message.fileUrl ? (
                      ...
                      {message.fileType !== 'image' && message.fileType !== 'video' && (
                        ...
                        >
                          ...
                          <div className="overflow-hidden">
                            <p className="text-sm font-semibold truncate max-w-45">{message.content}</p>
                    ...
                    <p className="text-sm pr-6 wrap-break-word whitespace-pre-wrap">{message.content}</p>
                  )}
